...
namespace CreativeSpore.SuperTilemapEditor
{
    ...
    public class Tilemap : MonoBehaviour
    {
		...
		public float flatternAngle = 5;
		public float flatternDistance = 100.0f;
		public bool autoCombineCollider = true;
        ...
        private TilemapChunk GetOrCreateTileChunk(int gridX, int gridY, bool createIfDoesntExist = false)
        {
...
#endif
            {
                ...
                if (tilemapChunk == null && createIfDoesntExist)
                {
					...
					chunkObj.hideFlags = HideFlags.None;//gameObject.hideFlags | HideFlags.HideInHierarchy; //NOTE: note the flags inheritance. BrushBehaviour object is not saved, so chunks are left orphans unless this inheritance is done
