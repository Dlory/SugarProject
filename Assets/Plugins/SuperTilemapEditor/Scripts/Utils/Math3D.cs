...
/// <summary>
/// From http://wiki.unity3d.com/index.php/3d_Math_functions#Author 
/// </summary>
public class Math3D {
	...
	public static bool AreLineSegmentsCrossing(out Vector3 crossPoint,Vector3 pointA1, Vector3 pointA2, Vector3 pointB1, Vector3 pointB2)
	{
		crossPoint = Vector3.zero;

		if(AreLineSegmentsCrossing(pointA1,pointA2,pointB1,pointB2))
		{
			return Math3D.LineLineIntersection(out crossPoint,pointA1,pointA2 - pointA1,pointB1,pointB2 - pointB1);
		}
	...
	/// <summary>
	/// 经过测试，如果两个线段的起点或者终点在另外一个线段里，会被判断为不相交
	/// 比如(0,1)(1,1) , (0,1)(0.5,1), (0,1)(0,1)
	/// </summary>
	public static bool AreLineSegmentsCrossing(out Vector2 crossPoint,Vector2 pointA1, Vector2 pointA2, Vector2 pointB1, Vector2 pointB2)
	{
		Vector3 outPut;
		crossPoint = Vector2.zero;

		if(AreLineSegmentsCrossing((Vector3)pointA1,(Vector3)pointA2,(Vector3)pointB1,(Vector3)pointB2))
		{
			bool crossed = Math3D.LineLineIntersection(out outPut,(Vector3)pointA1,(Vector3)(pointA2 - pointA1),(Vector3)pointB1,(Vector3)(pointB2 - pointB1));
