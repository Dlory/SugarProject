Shader "Custom/_RippleWater" {
  ...
  [HideInInspector]_Distance8 ("Distance8", float) = 0
	...
	SubShader {
		...
		CGPROGRAM
		#pragma surface surf Standard fullforwardshadows vertex:vert /*nofog keepalpha*/
		#pragma target 4.0
...
//			o.customColor.rgb = v.normal;
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			IN.customColor = IN.customColor*0.5 + 0.5f;

			o.Albedo = o.Albedo * IN.customColor.g;
		}
		ENDCG
	} 
	FallBack "Diffuse"
