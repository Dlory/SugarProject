...
[System.Serializable]
public class _2dxFX_GrassFX_Shadow : MonoBehaviour
{
	[HideInInspector] public Material ForceMaterial;
	[HideInInspector] public bool ActiveChange=true;
	private string shader = "2DxFX/Standard/GrassFX_Shadow";
...
#if UNITY_EDITOR
[CustomEditor(typeof(_2dxFX_GrassFX_Shadow)),CanEditMultipleObjects]
public class _2dxFX_GrassFX_Shadow_Editor : Editor
{
	...
	public override void OnInspectorGUI()
	{
		...
		_2dxFX_GrassFX_Shadow _2dxScript = (_2dxFX_GrassFX_Shadow)target;
