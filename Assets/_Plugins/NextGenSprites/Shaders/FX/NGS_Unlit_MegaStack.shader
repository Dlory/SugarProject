...
Shader "NextGenSprites/FX/MegaStack" {
	Properties {
		...
		_Layer4("Layer 3", 2D) = "black" {}
		_Layer4Color("Layer 3 Tint", Color) = (1,1,1,1)
		_Layer4Opacity("Layer 3 Opacity", Range(0, 1)) = 1
		_Layer4ScrollingX("Layer 3 X-Axis Scrolling", Range(-1, 1)) = 0
		_Layer4ScrollingY("Layer 3 Y-Axis Scrolling", Range(-1, 1)) = 0
